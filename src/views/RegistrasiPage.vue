            ...
            <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    :validation-schema="formValidate">
                        <!-- NIK Input -->
                        <div>
                            <label for="nik" class="block text-sm font-medium leading-6 text-gray-900">Nomor Induk Kependudukan</label>
                            <div class="mt-2">
                                <vee-field
                        ...
                        <div class="flex flex-col space-y-6">
                            ...
                            <button class="flex w-full justify-center bg-gray-800 border-2 rounded-md shadow-md px-6 py-2 text-sm font-bold text-gray-50 hover:bg-gray-900 hover:text-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-all">
...
export default {
    ...
    methods: {
        ...
        async register() {
            await this.$axios.post(`${this.$root.API_URL}/api/v1/auth/register`, this.formData)
            .then((response) => {
                this.redirectToHome();
