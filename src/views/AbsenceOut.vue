    ...
    <ion-page>
        ...
        <ion-content class="ion-padding" :fullscreen="true">
            ...
            <div v-if="statusGPS" class="absen-cont">
                ...
                <div v-if="statusGPS && RenderbtnAbsen && !imageUrl" class="flex w-full px-6 pb-2 space-x-5">
                    <ion-button @click="takeCheckOutPicture" id="check-out-button"
                ...
                <div class="flex w-full items-center justify-center mt-4 space-x-4 px-6">
                    <img class="image" v-if="imageUrl" :src="imageUrl" id="preview-photo" alt="Captured Photo"
...
async function uploadCheckOutImage(userNumber) {
    try {
       ...
       const result = await axios.post(`${API_URL.value}/api/v2/addOut/${userNumber}/${detAbsen.value.id}`,
            formData, {
            headers: headers
        });
        ...
        catchToast(result.data.message, 3000);
        redirectToHomePage();
    } catch (error) {
        catchToastError(error.data.message, 3000);
