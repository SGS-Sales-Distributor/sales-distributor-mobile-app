        ...
        <ion-content class="ion-padding" :fullscreen="true">
            ...
            <div v-if="statusGPS" class="absen-cont">
                ...
                <div v-if="statusGPS && RenderbtnAbsen && !imageUrl" class="flex w-full px-6 pb-2 space-x-5">
                    <ion-button @click="takeCheckInPicture" id="check-in-button"
...
async function uploadCheckInImage(userNumber) {
    try {
        ...
        await axios.post(`${API_URL.value}/api/v2/addIn/${userNumber}`,
            formData, {
            headers: headers
        });
        ...
        catchToast("Berhasil Absen Masuk", 3000);
        redirectToHomePage();
    } catch (error) {
        catchToastError('Gagal Absen Masuk', 3000);
